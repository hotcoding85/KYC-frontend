    ...
    <div className="flex flex-col justify-between w-full h-auto p-4 bg-white border rounded-2xl border-primary50">
      <div>
        ...
        <div className="flex mb-3 gap-x-4">
          ...
          <TextButton
            title="Sell"
            className="flex-1 px-10 py-2 mt-3 h-8 !w-[132px] !min-w-[114px] text-sm !text-textBlack bg-white border border-primary50 rounded-[10px]"
          />
        </div>
            ...
            {orderTypes.map((tab) => (
              <button
                ...
                className={`relative pb-3 px-1 ${
                  activeTab === tab ? "text-textBlack font-semibold" : "text-gray-500"
                } text-sm`}
              >
                {tab}
        ...
        <div className="flex justify-between px-2 mb-4">
          {percentages.map((percent) => (
            <button
              ...
              className={`text-sm ${selectedPercentage === percent ? "text-textBlack" : "text-gray-500"} text-xs`}
            >
              {percent}%
            </button>
          ))}
